...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewChartsButton: Button = findViewById(R.id.viewChartsButton)
        viewChartsButton.setOnClickListener {
            ...
            val entertainmentExpenseEditText: EditText =
                findViewById(R.id.entertainmentExpenseEditText)
            ...
            saveButton.setOnClickListener {
                ...
                val entertainmentExpense =
                    entertainmentExpenseEditText.text.toString().toIntOrNull()
